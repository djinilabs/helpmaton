...
- Pro Plan: 25,000 requests per day`;
    ...
    <ul>
      <li><strong>Pro Plan:</strong> 25,000 requests per day</li>
            ...
            upgradeOptionsHtml = `
    <p>You're already on the <strong>Pro plan</strong>. For higher limits or custom plans, please <a href="https://helpmaton.com/support">contact support</a>.</p>`;
          }
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <p style="margin-top: 30px;">
      <a href="https://helpmaton.com/subscription" style="background-color: #000; color: #fff; padding: 12px 24px; text-decoration: none; display: inline-block; border-radius: 4px;">Upgrade Subscription</a>
    </p>
  </div>
</body>
</html>`;
