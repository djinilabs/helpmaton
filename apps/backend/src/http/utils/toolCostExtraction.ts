 ...
 * 
 * The cost marker format is: __HM_TOOL_COST__:8000 (where 8000 represents cost in nano-dollars)
 ...
 *   - costUsd: The extracted cost in nano-dollars (e.g., 8_000_000 = $0.008), or undefined if not found
