...
export const SectionGroup: FC<SectionGroupProps> = ({
  ...
  return (
    <section
      className={`mb-8 w-full rounded-2xl border border-neutral-200 bg-neutral-50/50 dark:border-neutral-700 dark:bg-surface-100/50 ${compact ? "p-2 lg:p-3" : "p-4 lg:p-6"}`}
    >
