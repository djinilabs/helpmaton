    ...
    <div className="bg-white rounded-2xl shadow-medium p-8 border border-neutral-200">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="border border-neutral-200 rounded-xl p-5 bg-neutral-50/50">
          <div className="text-sm font-semibold text-neutral-600 mb-2">Input Tokens</div>
          <div className="text-3xl font-bold text-neutral-900">{formatNumber(stats.inputTokens)}</div>
        </div>
        <div className="border border-neutral-200 rounded-xl p-5 bg-neutral-50/50">
          <div className="text-sm font-semibold text-neutral-600 mb-2">Output Tokens</div>
          <div className="text-3xl font-bold text-neutral-900">{formatNumber(stats.outputTokens)}</div>
        </div>
        <div className="border border-neutral-200 rounded-xl p-5 bg-neutral-50/50">
          <div className="text-sm font-semibold text-neutral-600 mb-2">Total Tokens</div>
          <div className="text-3xl font-bold text-neutral-900">{formatNumber(stats.totalTokens)}</div>
        </div>
            ...
            {stats.byModel.map((model) => (
              ...
              >
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-neutral-900">{model.model}</span>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            {stats.byProvider.map((provider) => (
              ...
              >
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-neutral-900">{provider.provider}</span>
                  <div className="text-right">
                    <div className="text-sm text-neutral-600">
      ...
      <div>
        <h4 className="text-xl font-bold text-neutral-900 mb-4">By Key Type</h4>
