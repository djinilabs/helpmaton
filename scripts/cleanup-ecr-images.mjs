 ...
 *   --retention <number>   Number of production images to keep (default: 3)
...
const CONFIG = {
  ...
  PRODUCTION_IMAGE_RETENTION_COUNT: parseInt(process.env.PRODUCTION_IMAGE_RETENTION_COUNT || '3', 10),
